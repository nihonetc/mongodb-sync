...
BACKUP_CMD="mongodump --forceTableScan --out /backup/${BACKUP_NAME} --host ${MONGODB_BACKUP_HOST} --port ${MONGODB_BACKUP_PORT} --authenticationDatabase admin ${USER_BACKUP_STR}${PASS_BACKUP_STR}${DB_BACKUP_STR} ${EXTRA_BACKUP_OPTS}"
