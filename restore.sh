...
if mongorestore --drop --host ${MONGODB_RESTORE_HOST} --port ${MONGODB_RESTORE_PORT} --username '${MONGODB_RESTORE_USER}' --password '${MONGODB_RESTORE_PASS}' /backup/$FILE_TO_RESTORE; then
